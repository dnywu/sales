...
//    public class When_generate_invoice_number_monthly_mode
//    {
//        static MongoCollection<InvoiceAutoNumberConfig> configCol;
//        static MongoCollection<InvoiceAutoNumberMonthly> autoNumberCol;
...
//            autoNumberCol = cfg.MongoDatabase.GetCollection<InvoiceAutoNumberMonthly>(typeof(InvoiceAutoNumberMonthly).Name);
//            gen = new InvoiceAutoNumberGenerator(cfg);
//            configCol.Save<InvoiceAutoNumberConfig>(new InvoiceAutoNumberConfig(typeof(InvoiceAutoNumberConfig).Name, AutoNumberMode.Monthly, "INV-", "oetawan@gmail.com"));
//        };
...
//        {
//            result.ShouldEqual("INV-20120100002");
//        };

//        Cleanup cleanup = () =>
//        {
//            configCol.Remove(Query.And(Query.EQ("_id", typeof(InvoiceAutoNumberConfig).Name), Query.EQ("CompanyId", "oetawan@gmail.com")));
//            autoNumberCol.Remove(Query.And(Query.EQ("_id", "201201"), Query.EQ("CompanyId", "oetawan@gmail.com")));
//        };
//    }
//}